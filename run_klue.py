...
def add_general_args(parser: argparse.ArgumentParser, root_dir: str) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--seed", type=int, default=8, help="random seed for initialization") # seed change
...
def main() -> None:
    # run_klue.py 다음 나오는 args == command
    command = sys.argv[1].lower()

    # argparse의 ArgumentParser 생성
